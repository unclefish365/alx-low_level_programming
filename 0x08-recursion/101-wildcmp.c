...
/**
 * iterate_wild - iterates thru a string located at a wildcard
 * until it ppoints to a non-wildcard character
 * @wildstr: the string to be iterated thru
 */
void iterate_wild(char **wildstr)
{
	if (**wildstr == '*')
 ...
 * to the null byte located at end of postfix
 ...
 *
 * Return: if strings can be considered identical - 1
 * otherwise - 0
 */
int wildcmp(char *s1, char *s2)
{
