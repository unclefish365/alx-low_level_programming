...
/**
 * iterate_zeroes - iterates thru a string of numbers containing
 * leading zeroes until it hits a non-zero number
 * @str: the string of numbers to iterate thru
 *
 ...
 * one number contains non-digits, function exits with
 * a status of 98
 * Return: always 0
 */
